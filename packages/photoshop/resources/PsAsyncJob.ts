...
import { PsJobResponse } from "../src/models/PsJobResponse";
import { JobStatusLinkResponse } from "../src/models/JobStatusLinkResponse";
import { JobOutputStatus } from "../src/models/JobOutputStatus";
...
/**
 * This is manually created class to handle the async job status for Photoshop APIs
 */
